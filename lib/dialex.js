(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("dialex", [], factory);
	else if(typeof exports === 'object')
		exports["dialex"] = factory();
	else
		root["dialex"] = factory();
})(this, function() {
...
exports.Dialex = undefined;

var _Dialex = __webpack_require__(15);

var _Dialex2 = _interopRequireDefault(_Dialex);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.Dialex = _Dialex2.default;
...
var Dialex = function () {
  ...
  _createClass(Dialex, [{
    key: 'transform',
    value: function transform(transformContent, lang) {
      var self = this;

      return new Promise(function (resolve, reject) {
        _axios2.default.get(self.url + '/api/v1/process', {
          params: {
            apikey: self.key,
            data: transformContent,
            lang: lang
          } }).then(function (response) {
          return resolve(response.data.output.result);
        }).catch(function (err) {
...
//# sourceMappingURL=dialex.js.map